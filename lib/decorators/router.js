...
const RequiredDecorator = (rules) => (...args) => utils_1.Decorate(args, (ctx, next) => __awaiter(this, void 0, void 0, function* () {
...
const GetSchemaFromType = (Type) => {
    const metadatas = class_validator_1.getFromContainer(class_validator_1.MetadataStorage)
        .validationMetadatas;
    const allSchemas = class_validator_jsonschema_1.validationMetadatasToSchemas(metadatas);
...
exports.RequiredBody = (Type) => RequiredDecorator({
    body: GetSchemaFromType(Type),
});
exports.RequiredQuery = (Type) => RequiredDecorator({
